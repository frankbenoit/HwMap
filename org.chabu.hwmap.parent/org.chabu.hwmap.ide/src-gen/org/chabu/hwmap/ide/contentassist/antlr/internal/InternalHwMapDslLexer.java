...
public class InternalHwMapDslLexer extends Lexer {
    ...
    public final void mT__13() throws RecognitionException {
        try {
            ...
            // InternalHwMapDsl.g:11:7: ( 'VHDL' )
            // InternalHwMapDsl.g:11:9: 'VHDL'
            {
            match("VHDL"); 
    ...
    public final void mT__14() throws RecognitionException {
        try {
            int _type = T__14;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:12:7: ( 'C' )
            // InternalHwMapDsl.g:12:9: 'C'
            {
            match('C'); 
    ...
    public final void mT__15() throws RecognitionException {
        try {
            int _type = T__15;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:13:7: ( 'Output' )
            // InternalHwMapDsl.g:13:9: 'Output'
            {
            match("Output"); 
    ...
    public final void mRULE_INT_DEC() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1790:14: ( ( ( '-' )? '1' .. '9' ( '0' .. '9' )* | '0' ) )
            // InternalHwMapDsl.g:1790:16: ( ( '-' )? '1' .. '9' ( '0' .. '9' )* | '0' )
            {
            // InternalHwMapDsl.g:1790:16: ( ( '-' )? '1' .. '9' ( '0' .. '9' )* | '0' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalHwMapDsl.g:1790:17: ( '-' )? '1' .. '9' ( '0' .. '9' )*
                    {
                    // InternalHwMapDsl.g:1790:17: ( '-' )?
                    int alt1=2;
                    ...
                    matchRange('1','9'); 
                    // InternalHwMapDsl.g:1790:31: ( '0' .. '9' )*
                    loop2:
                    do {
                        int alt2=2;
                        ...
                        switch (alt2) {
                    	case 1 :
                    	    // InternalHwMapDsl.g:1790:32: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_INT_HEX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1792:14: ( '0x' ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ )
            // InternalHwMapDsl.g:1792:16: '0x' ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+
            {
            match("0x"); 

            // InternalHwMapDsl.g:1792:21: ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_OP_2DOT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1794:14: ( '..' )
            // InternalHwMapDsl.g:1794:16: '..'
            {
            match(".."); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1796:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalHwMapDsl.g:1796:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalHwMapDsl.g:1796:11: ( '^' )?
            int alt5=2;
            ...
            // InternalHwMapDsl.g:1796:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1798:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalHwMapDsl.g:1798:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalHwMapDsl.g:1798:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalHwMapDsl.g:1798:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalHwMapDsl.g:1798:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalHwMapDsl.g:1798:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalHwMapDsl.g:1798:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1800:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalHwMapDsl.g:1800:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalHwMapDsl.g:1800:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1802:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalHwMapDsl.g:1802:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalHwMapDsl.g:1802:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1804:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalHwMapDsl.g:1804:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalHwMapDsl.g:1804:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHwMapDsl.g:1806:16: ( . )
            // InternalHwMapDsl.g:1806:18: .
            {
            matchAny(); 
    ...
    static final String DFA15_eotS =
        "\1\uffff\1\25\1\27\1\25\2\uffff\1\25\2\uffff\1\23\1\uffff\1\36\2\23\1\uffff\3\23\2\uffff\1\25\1\uffff\1\25\1\uffff\1\25\2\uffff\1\25\11\uffff\5\25\1\57\4\25\1\uffff\3\25\1\67\2\25\1\72\1\uffff\2\25\1\uffff\1\25\1\76\1\77\2\uffff";
    static final String DFA15_eofS =
        "\100\uffff";
    static final String DFA15_minS =
        "\1\0\1\110\1\60\1\165\2\uffff\1\154\2\uffff\1\61\1\uffff\1\170\1\56\1\101\1\uffff\2\0\1\52\2\uffff\1\104\1\uffff\1\155\1\uffff\1\164\2\uffff\1\157\11\uffff\1\114\1\160\1\163\1\160\1\143\1\60\1\157\1\164\1\165\1\153\1\uffff\1\156\1\141\1\164\1\60\1\145\1\156\1\60\1\uffff\1\156\1\164\1\uffff\1\164\2\60\2\uffff";
    static final String DFA15_maxS =
        "\1\uffff\1\110\1\172\1\165\2\uffff\1\154\2\uffff\1\71\1\uffff\1\170\1\56\1\172\1\uffff\2\uffff\1\57\2\uffff\1\104\1\uffff\1\156\1\uffff\1\164\2\uffff\1\157\11\uffff\1\114\1\160\1\163\1\160\1\143\1\172\1\157\1\164\1\165\1\153\1\uffff\1\156\1\141\1\164\1\172\1\145\1\156\1\172\1\uffff\1\156\1\164\1\uffff\1\164\2\172\2\uffff";
    static final String DFA15_acceptS =
        "\4\uffff\1\5\1\6\1\uffff\1\10\1\11\1\uffff\1\13\3\uffff\1\16\3\uffff\1\22\1\23\1\uffff\1\16\1\uffff\1\2\1\uffff\1\5\1\6\1\uffff\1\10\1\11\1\13\1\14\1\15\1\17\1\20\1\21\1\22\12\uffff\1\1\7\uffff\1\7\2\uffff\1\3\3\uffff\1\12\1\4";
    static final String DFA15_specialS =
        "\1\1\16\uffff\1\2\1\0\57\uffff}>";
    static final String[] DFA15_transitionS = {
            "\11\23\2\22\2\23\1\22\22\23\1\22\1\23\1\17\4\23\1\20\5\23\1\11\1\14\1\21\1\13\11\12\7\23\1\16\1\6\1\2\13\16\1\3\6\16\1\1\4\16\1\7\1\23\1\10\1\15\1\16\1\23\32\16\1\4\1\23\1\5\uff82\23",
            "\1\24",
            "\12\25\7\uffff\32\25\4\uffff\1\25\1\uffff\16\25\1\26\13\25",
            "\1\30",
            "",
            "",
            "\1\33",
